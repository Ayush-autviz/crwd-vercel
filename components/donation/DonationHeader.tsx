  ...
  return (
    <div className="flex items-center h-16 p-4 border-b">
      ...
      {showCloseButton && !showBackButton && (
        <Link href="/" className="flex items-center justify-center h-8 w-8 rounded-full bg-gray-100 text-gray-700 hover:bg-gray-200 transition-colors mr-2">
          <X size={18} />
        </Link>
      )}
      
      <h1 className="text-center flex-1 text-xl font-bold">{title}</h1>
