...
export default function NotificationTabs() {
  const [activeTab, setActiveTab] = useState<'notifications' | 'community'>('community')
    ...
    <div className="w-full">
      ...
      <div className="flex border-b border-gray-200">
        ...
        <button
          ...
          className={`relative flex-1 flex-row items-center justify-center gap-2 px-6 py-4 text-sm font-medium transition-colors ${
