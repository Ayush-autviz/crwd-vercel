    ...
    <html lang="en">
      ...
      <div className="hidden md:flex md:fixed md:inset-y-0 md:left-0 md:z-50 md:w-72 md:flex-col md:border-r md:bg-card">
        <div className="flex h-16 items-center px-6 border-b">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-gradient-to-br from-primary to-purple-600 rounded-md flex items-center justify-center text-white font-bold">
              C
            </div>
            <span className="text-xl font-bold">CRWD</span>
          </div>
        </div>
      ...
      <div className="md:pl-72">
        ...
        <div className="hidden md:block">
          {/* Desktop Header */}
          <header className="bg-card border-b p-3 flex items-center justify-between sticky top-0 z-10">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                <div className="absolute top-0 right-0 w-3 h-3 bg-destructive rounded-full"></div>
                <Avatar>
                  <AvatarImage src="/placeholder.svg?height=40&width=40" alt="User" />
                  <AvatarFallback>JD</AvatarFallback>
                </Avatar>
